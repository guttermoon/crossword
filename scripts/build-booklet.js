  ...
  <div class="cols">
    ...
    <div class="dia">
      <svg viewBox="0 0 210 148" aria-hidden="true">
        ...
        <rect x="103.5" y="42" width="3" height="14" fill="currentColor"/>
        <rect x="103.5" y="92" width="3" height="14" fill="currentColor"/>
      </svg>
      <p>The fold runs down the middle of the landscape sheet. The two marks
        are where the staples go &mdash; lying <b>along</b> the fold, not across
        it, so the legs close on either side of the crease.</p>
